...
public class Utility {
     ...
     * @return
     */
    public synchronized static boolean handleProvincesResponse(WeatherDB yakerWeatherDB, String response) {
     ...
     * @return
     */
    public synchronized static boolean handleCitiesResponse(WeatherDB yakerWeatherDB, String response, int provinceId) {
        if(!TextUtils.isEmpty(response)) {
     ...
     * @return
     */
    public synchronized static boolean handleCountiesResponse(WeatherDB yakerWeatherDB, String response, int cityId) {
        if(!TextUtils.isEmpty(response)) {
